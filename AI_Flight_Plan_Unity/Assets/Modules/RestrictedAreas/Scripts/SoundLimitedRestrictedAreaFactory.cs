...
public class SoundLimitedRestrictedAreaFactory : MonoBehaviour
{
    ...
    public GameObject Spawn(Vector3 position, float radius, float soundLimit_dBa = 50f, Color? minSoundColor = null, Color? maxSoundColor = null)
    {
        ...
        soundLimitedRestrictedArea.SetRadius(radius);
        soundLimitedRestrictedArea.SetSoundLimit(soundLimit_dBa);
