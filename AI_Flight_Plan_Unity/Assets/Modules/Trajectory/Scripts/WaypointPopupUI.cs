...
public class WaypointPopupUI : MonoBehaviour
{
    public static WaypointPopupUI Instance { get; private set; }
    ...
    public void ShowPopup(Waypoint waypoint)
    {
        ...
        Vector3 worldPoint = waypoint.transform.position;
        // try to offset above the aircraft using renderer bounds if available
        var rend = waypoint.GetComponentInChildren<Renderer>();
